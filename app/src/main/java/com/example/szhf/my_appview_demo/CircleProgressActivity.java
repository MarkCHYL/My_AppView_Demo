...
import com.example.szhf.my_appview_demo.view.CircleProgressView;
...
public class CircleProgressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = (CircleProgressView) findViewById(R.id.circleProgress);
        findViews();
        initData();
    ...
    private void initData() {
        ...
        listSpeeds.add("4000");
        listSpeeds.add("5000");
        adapter = new ArrayAdapter<String>(CircleProgressActivity.this,
    ...
    private void initEvent() {
        view.setOnLoadingCompleteListenter(new CircleProgressView.OnLoadingCompleteListenter() {
            @Override
            public void onComplete() {
                Toast.makeText(CircleProgressActivity.this, "完成", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(data1)) {
                    Toast.makeText(CircleProgressActivity.this, "填写总成绩", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(data2)) {
                    Toast.makeText(CircleProgressActivity.this, "填写当前成绩", Toast.LENGTH_SHORT).show();
                    return;
                }
                totalScore = Integer.parseInt(data1);
                currentScore = Integer.parseInt(data2);
                if (currentScore > totalScore) {
                    Toast.makeText(CircleProgressActivity.this, "当前成绩不能大于总成绩", Toast.LENGTH_SHORT).show();
                    return;
